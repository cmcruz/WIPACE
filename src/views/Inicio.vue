    ...
    <mdb-card class="card-image" v-bind:style="fondo">
      <div class="text-white text-center rgba-black-strong py-5 px-4">
        <div class="py-5">
          ...
          <mdb-btn class="blue-grey-text" tag="a" gradient="dusty-grass" icon="key" href="https://platea.ujaen.es/" v-show="!prof">Platea</mdb-btn>
      ...
      <mdb-jumbotron class="mb-0 text-center hoverable p-4">
        <mdb-row>
          ...
          <mdb-col md="7" class="text-left ml-3 mt-3">
            ...
            <p class="lead text-muted">Esta web ha sido creada como parte de los Proyectos de Innovación y Mejora Docente PIMED06_201921 y PIMED01_202224, financiados por la Universidad de Jaén.</p>
          </mdb-col>
        </mdb-row>
      </mdb-jumbotron>
