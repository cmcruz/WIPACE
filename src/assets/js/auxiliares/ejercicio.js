...
export class Ejercicio {
     ...
     * @param {String} enunciadoENG Enunciado en inglés del ejercicio en HTML.
     * @param {String} ayuda Explicación del ejercicio en HTML.
     * @param {String} video URL del vídeo explicativo
     */
    constructor( id, dificultad, enunciado = '', enunciadoENG = '', ayuda = '', video = '') {
        this.id = id;
        this.dificultad = dificultad;
        this.enunciado = enunciado;
        this.enunciadoENG = enunciadoENG;
        this.ayuda = ayuda;
        this.video = video;
    }
}
...
export class Viga extends Ejercicio {
     ...
     */
    constructor( id, dificultad, enunciado = '', enunciadoENG = '', ayuda = '', video = '', tramos = [], elementos = [], formulas = [], auxiliares = [], E, I) {
        super(id, dificultad, enunciado, enunciadoENG, ayuda, video);
        this._tramos = tramos;
...
export class Mohr extends Ejercicio {
     ...
     * @param {Number} v 
     */
    constructor( id, dificultad, enunciado = '', enunciadoENG = '', ayuda = '', video = '', sx, sy, txy, s1, s2, a, B, E, v) {
        super(id, dificultad, enunciado, enunciadoENG, ayuda, video);
        this.sx = sx;
        this.sy = sy;
        this.txy = txy;
 ...
 */
 export class Matriz extends Ejercicio {
     ...
     */
    constructor( id, dificultad, enunciado = '', enunciadoENG = '', ayuda = '', video = '', materiales = [], secciones = [], nodos = [], barras = [], bc = [], cargas = []) {
        super(id, dificultad, enunciado, enunciadoENG, ayuda, video);
