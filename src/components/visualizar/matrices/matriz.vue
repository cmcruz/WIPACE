        ...
        <template :slot="'Desplazamientos y reacciones'">
            ...
            <mdb-row class="container">
                <mdb-col size="md" md="4">
                    <mdb-input placeholder="Factor amplificador" class="mb-3 mt-0" v-model="factor" :min="0" :step="1" @change="verDesp = false; actualizaDibujo()">
                        <span class="input-group-text md-addon" slot="prepend">Factor amplificador</span>
                    </mdb-input>
                </mdb-col>
                <mdb-col size="md" md="8" class="text-center">
                    <mdb-btn size="sm" block v-show="verDesp" color="primary" @click="verDesp = false; actualizaDibujo()"><mdb-icon icon="eye-slash" class="mr-1"/> Ocultar desplazamientos nodales</mdb-btn>
                    <mdb-btn size="sm" block v-show="!verDesp" color="default" @click="verDesp = true; actualizaDibujo()"><mdb-icon far icon="eye" class="mr-1"/> Mostrar desplazamientos nodales</mdb-btn>
                </mdb-col>
            </mdb-row>
