        ...
        <mdb-card class="mb-3">
            <mdb-row class="my-3" style="box-sizing: none;">
                <mdb-col class="my-2" md="6" col="md" ref="seccion">
                    ...
                    <mdb-row>
                        <mdb-col md="12">
                            <h4 class="text-align mt-3" style="margin: 10px;"><small class="text-muted">Esfuerzos:</small></h4>
                    ...
                    <mdb-row>
                        <mdb-col md="12">
                            <h4 class="text-align mt-3" style="margin: 10px;"><small class="text-muted">Datos de la sección:</small></h4>
                            <div class="md-form input-group">
                                <div class="input-group-prepend">
                    ...
                    <h4 class="text-center mt-3"><small class="text-dark">Resultados</small></h4>
                    <mdb-row>
                        <mdb-col md="12">
                            <h4 class="text-align mt-3" style="margin: 10px;"><small class="text-muted">Fibra neutra:</small></h4>
                            <div class="md-form input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text md-addon"><b>Corte en Y:</b></span>
                                    <span class="input-group-text md-addon" v-show="corteY != null">{{ corteY }} mm</span>
                                </div>
                                <div class="input-group-prepend">
                                    <span class="input-group-text md-addon"><b>Corte en Z:</b></span>
                                    <span class="input-group-text md-addon" v-show="corteZ != null">{{ corteZ }} mm</span>
                                </div>
                            </div>
                            <h4 class="text-align mt-3" style="margin: 10px;"><small class="text-muted">Tensiones normales extremas:</small></h4>
                            <div class="md-form input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text md-addon"><b>Máxima: </b></span>
                                    <span class="input-group-text md-addon" v-show="tensionMaxima != null">{{ tensionMaxima }} MPa</span>
                                </div>
                                <div class="input-group-prepend">
                                    <span class="input-group-text md-addon"><b>Mínima:</b></span>
